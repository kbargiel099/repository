...
public class HomePageDAOImpl implements HomePageDAO{
	...
	public List<AuctionPresenter> getBestAuctionsByCategory(String category){
		return dao.query("SELECT id,name,image_name,subject_price FROM sys.auction_main WHERE category_name=?", 
	...
	public List<AuctionPresenter> getNewestAuction(){
		return dao.query("SELECT id,name,image_name,subject_price FROM sys.auction_main ORDER BY create_date DESC LIMIT 20", 
